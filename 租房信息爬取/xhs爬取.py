...
data = {"keyword":"相城魅力花园租房","page":1,"page_size":20,"search_id":"2g20e6ykgdpbuireo4v6c@2g20e7o77r7huu6z9gc9y","sort":"general","note_type":0,"ext_flags":[],"filters":[{"tags":["time_descending"],"type":"sort_type"},{"tags":["不限"],"type":"filter_note_type"},{"tags":["不限"],"type":"filter_note_time"},{"tags":["不限"],"type":"filter_note_range"},{"tags":["不限"],"type":"filter_pos_distance"}],"geo":"","image_formats":["jpg","webp","avif"]}
    ...
    for i in range(1, 10):
        ...
        for i in data_list:
            try:
                ...
                url = new_url(id, xsec_token)  # 组合详情地址
